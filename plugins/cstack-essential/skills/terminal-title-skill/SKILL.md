...
3. **Set Title**: Execute the `~/.claude/plugins/marketplaces/claude-stack/plugins/cstack-essential/skills/terminal-title-skill/scripts/set_title.sh` script with the generated title
...
```bash
bash ~/.claude/plugins/marketplaces/claude-stack/plugins/cstack-essential/skills/terminal-title-skill/scripts/set_title.sh "Your Title Here"
```

**Example workflow:**
```bash
# User asks: "Help me debug the authentication flow in the API"
bash ~/.claude/plugins/marketplaces/claude-stack/plugins/cstack-essential/skills/terminal-title-skill/scripts/set_title.sh "Debug: Auth API Flow"

# User asks: "Create a React component for the user profile page"
bash ~/.claude/plugins/marketplaces/claude-stack/plugins/cstack-essential/skills/terminal-title-skill/scripts/set_title.sh "Build: User Profile UI"

# User asks: "Write tests for the payment processing module"
bash ~/.claude/plugins/marketplaces/claude-stack/plugins/cstack-essential/skills/terminal-title-skill/scripts/set_title.sh "Test: Payment Module"
```
